	...
	return (
		<ToggleGroupPrimitive.Item
			...
			className={cn(
				...
				'data-[variant=outline]:ltr:border-l-0 data-[variant=outline]:rtl:border-r-0 data-[variant=outline]:ltr:first:border-l data-[variant=outline]:rtl:first:border-r',
				className,
			)}
			{...props}
		>
