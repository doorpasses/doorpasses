		...
		<Card className="w-full gap-0">
			<CardHeader className={`space-y-3 ${isChecked ? 'border-b': ''}`}>
				...
				<CardDescription className="text-sm text-muted-foreground">
					When someone signs up using an email that matches your
					verified domain, they will be automatically added to your organization
					as a member.
				</CardDescription>
			</CardHeader>
			<div
				...
				<Form method="POST" {...getFormProps(form)}>
					...
					<CardContent className="py-2">
						...
						<div className="flex items-center text-xs text-primary">
							<InfoIcon className="mr-1 mt-0.5 h-4 w-4 flex-shrink-0" />
