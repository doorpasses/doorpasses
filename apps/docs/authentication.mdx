...
DoorPasses uses a **dual authentication mechanism** to ensure secure API access. Every API request must include two headers:
...
<CodeGroup>
```bash cURL
curl -X GET https://api.doorpasses.com/v1/health \
