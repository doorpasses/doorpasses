---
title: 'Usage Guide'
description: 'How to use the DoorPasses Node.js SDK'
---
...
```javascript
const { DoorPassesClient, DoorPassesError, ValidationError, UnauthorizedError } = require('@doorpasses/node-sdk');
...
try {
  ...
  if (error instanceof ValidationError) {
    ...
    // Check credentials
  } else if (error instanceof DoorPassesError) {
...
```typescript
import { DoorPassesClient, AccessPass, AccessPassState, CreateAccessPassRequest } from '@doorpasses/node-sdk';
